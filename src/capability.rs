...
use crate::repack_plan::{RepackDescriptor, RepackSelection, RowIdentity};
...
impl OpFamily {
    ...
    #[must_use]
    pub const fn consumed_tensor_classes(self) -> &'static [GgmlType] {
        match self {
            Self::Gather | Self::LogitsHead => &[GgmlType::Q8_0],
