...
- `Tensor<f32>::neg` and tape-owned `AutogradTape::neg` provide the first true
  ...
  Gelu implemented with VJP and finite-difference oracle; Softmax forward-only (VJP deferred to cross-entropy goal); Exp, Log, sin, cos, tanh remain pending.
